...
async def handle_links_download_all(client: Client, cq: CallbackQuery, original_msg: Message):
    content = (original_msg.text or original_msg.caption or "") or ""
...
async def auto_react_handler(client: Client, message: Message):
    # apne hi bot ya kisi bot ke message pe react nahi karna
    if message.from_user and message.from_user.is_bot:
        return
    # empty / special messages skip
    if message.empty:
        return
    ...
    try:
        ...
        # agar permission nahi hai ya reaction disabled hai to ignore
        pass
